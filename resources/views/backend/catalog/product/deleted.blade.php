...
@section ('title', __('labels.backend.catalog.products.management') . ' | ' . __('labels.backend.catalog.products.deleted'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">{{ __('labels.backend.catalog.products.deleted') }}</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
                ...
                <table class="table">
                    ...
                    <tbody>
                        @if ($products->count())
                            ...
                            @endforeach
                        @else
                        <tr><td colspan="9"><p class="text-center">Não há produtos excluídos.</p></td></tr>
                        @endif
                    </tbody>
                </table>
            </div><!--col-->
